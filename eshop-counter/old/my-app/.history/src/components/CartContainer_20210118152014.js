...
const PriceTotal = ({control}) => {
    ...
    console.log('total value from watch', value)
...
const CartContainer = () => {
    ...
    const {
      ...
      } = useFieldArray({ control, name: "itemsSection" });
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {sectionFields.map(({id}, index) => {
                                return(
                                    ...
                                    <div key={id}>
                                         <section className='group border-dotted border-2 ring-black p-4 my-4 overflow-auto'></section>
                                        ...
                                        {fields.map( ({id, name, type, amount}, index) => {
                                            return (
                                                <div key={id}>
                                                    <input className='text-black border p-1 rounded' ref={ register()} name={`items[${index}].name`} defaultValue={name} />
                                                    <select className='text-black border p-1 rounded'  ref={ register()} name={`items[${index}].type`} defaultValue={type}>
                                                        <option value="">Select</option>
                                                        <option value="10">item1</option>
                                                        <option value='20'>item1</option>
                                                    </select>
                                                    <input className='text-black border p-1 rounded' ref={ register()} type='number' name={`items[${index}].amount`} defaultValue={amount}/>
                                                    <Price control={control} index={index}/>
                                                    <button className='text-black border p-1 rounded' type='button' onClick={()=> remove({index})}>Remove</button>
                                        ...
                                        <section className="sectionGroup border-dotted border-2 ring-black p-4 my-4 overflow-auto">
                                            ...
                                            return(
                                             ...
                                             <button onClick={() => groupAppend({})} className="add-new-section-group-btn text-black border p-1 rounded ml-56 float-right" type="button">
                                                Add
                                            </button>
                            ...
                            <button onClick={() => sectionAppend({})} className="add-new-group-btn text-black border p-1 rounded float-right" type="button">
                                    Add
                                </button>
                                <button onClick={() => sectionRemove({})} className="add-new-group-btn text-black border p-1 rounded float-right" type="button">
                                    Remove
                                </button> 

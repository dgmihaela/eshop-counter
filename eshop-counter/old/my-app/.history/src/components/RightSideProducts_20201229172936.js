    ...
    return(
        <div  className='leftSide border-pink-600 w-4/5 '>
            <div className='w-80 h-96 bg-gray-50 shadow-md py-5 px-5 '>
                ...
                <div className='btns-counter h-12 box-border'>
             

                    <button className='inline-block rounded w-12 h-12 bg-gray-100 pl-3 pt-1.5' >
                        <div className='w-6 h-6 bg-no-repeat bg-contain' style={{backgroundImage: `url(${minus})`}}></div>
                    </button>
                    
                    <div className='rounded inline-block w-12 h-12 text-center bg-gray-100'><span>44</span></div>
                    <button className='inline-block rounded w-12 h-12 bg-gray-100 pl-3 pt-1.5 box-border' >

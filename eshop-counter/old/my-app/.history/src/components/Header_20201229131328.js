...
const Header = () => {
    ...
    return(
      <div className='grid grid-cols-2 gap-50  h-12 justify-items-center '>
          ...
          <div className="inline-block min-w-min w-36 h-12 grid grid-cols-2 place-content-right border-gray-900">

            <div className='text-right inline-block min-w-min w-36  h-12'>Hello Ela <button>Logout</button> </div>

            <div className="shopCart  w-36  h-12 " style={{backgroundImage: `url(${cart})`}}></div>

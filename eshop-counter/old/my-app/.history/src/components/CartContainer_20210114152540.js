                ...
                <div >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="individual-input mt-7">
                            <label className='mr-4 text-grey-darkest border' htmlFor="costName">Cost Name</label>
                            <input
                        ...
                        <section className='group border-dotted border-2 ring-black p-4 my-4'>
                            ...
                            <input ref={register} name="rueValue" placeholder='Rue Value' />
                                <section className="sectionGroup border-dotted border-2 ring-black p-4 my-4">
                                    <div>
                                    <select
                                        className="selectionGroup-select mr-4"
                                        ref={register}
                                        name="type1"
                                    >
                                        <option>All</option>
                            ...
                            <button className="add-new-group-btn ml-96 " type="button">
                                Add
                            </button>
                        </section>

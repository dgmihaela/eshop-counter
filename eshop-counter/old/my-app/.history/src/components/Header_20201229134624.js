    ...
    return(
      <div className='grid grid-cols-2 gap-50  h-12 justify-items-center bg-blue-400'>
          ...
          <div className="cart inline-block min-w-min w-36 flex justify-end h-12">
            ...
            <div className='text-right inline-block min-w-min w-36 h-12 py-2 ml-8'>Hello Ela <button className='bg-white px-1 py-0.5 rounded'>Logout</button> </div>

            <div className="shopCart m w-20 h-12 ml-8" ><button className='bg-contain w-20 h-12 bg-no-repeat' style={{backgroundImage: `url(${cart})`}}></button></div>

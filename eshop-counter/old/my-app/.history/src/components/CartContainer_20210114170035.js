                    ...
                    <div className='mt-8'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="individual-input pb-2">
                                ...
                                {errors.costDetails && <p>{errors.costDetails.message}</p>}
                            </div>

                            <div className="individual-input pb-2">
                                <label className='mr-4 ' htmlFor="costType">Cost Type</label>
                                <Select options={costTypeOptions} className='text-black border p-1 rounded w-1/4' ref={register} name="costType" />
                                    ...
                                    <section className="sectionGroup border-dotted border-2 ring-black p-4 my-4 overflow-auto">
                                        ...
                                        <div className='pb-2'>
                                            ...
                                            <select
                                                ...
                                                name="type4"
                                            >
                                                <option>Select one/not one</option>
                                                <option>One</option>

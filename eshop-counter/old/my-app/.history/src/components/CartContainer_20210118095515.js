                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <section className='group border-dotted border-2 ring-black p-4 my-4 overflow-auto'>
                                ...
                                {fields.map( ({id}, index) => {
                                    return (
                                        <div key={id}>
                                            <input className='text-black border p-1 rounded' ref={ register()} name={`items[${index}].name`} />
                                            <select className='text-black border p-1 rounded'  ref={ register()} name={`items[${index}].type`}>
                                                <option value="">Select</option>
                                                <option value="item1">item1</option>
                                                <option value='item2'>item1</option>
                                            </select>
                                            <input className='text-black border p-1 rounded' ref={ register()} type='number' name={`items[${index}].amount`}/>

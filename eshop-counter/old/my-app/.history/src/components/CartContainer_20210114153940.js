                    ...
                    <div className='mt-8'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="individual-input pb-2">
                                ...
                                <select className='text-black border p-1 rounded' ref={register} name="type">
                                    <option>Fixed</option>
                            ...
                            <section className='group border-dotted border-2 ring-black p-4 my-4'>
                                ...
                                <input className='text-black border p-1 rounded' ref={register} name="rueValue" placeholder='Rue Value' />
                                    <section className="sectionGroup border-dotted border-2 ring-black p-4 my-4">
                                        ...
                                        <button className="add-new-section-group-btn text-black border p-1 rounded ml-56" type="button">
                                            Add
                                        </button>
                                    </section>
                                    <div>
                                        <button className="add-new-group-btn text-black border p-1 rounded flex items-end" type="button">
                                            Add
                                        </button>
                                    </div>                      

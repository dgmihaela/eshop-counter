                    ...
                    <div className='mt-8'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {sectionFields.map(({id}, index) => {
                                ...
                                <button onClick={() => sectionAppend({index})} className="add-new-group-btn text-black border p-1 rounded float-right" type="button">
                                    Add
                                </button>
                                <button onClick={() => sectionRemove({index})} className="add-new-group-btn text-black border p-1 rounded float-right" type="button">
                                    Remove
                                </button>                   
                            </section>

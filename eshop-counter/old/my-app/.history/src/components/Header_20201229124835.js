...
const Header = () => {
    ...
    return(
      <div className='grid grid-cols-2 gap-50  h-48 justify-items-center'>
          <div className="logo inline-block min-w-min w-36 grid grid-cols-7 place-content-leftt h-16 justify-start">
           <div className='logo-image bg-contain  w-20 h-12' style={{backgroundImage: `url(${logo})`}} ></div>
           <div className='inline-block w-36'>Ella's kitcken</div>
          </div>

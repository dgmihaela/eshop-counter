                ...
                <div >
                    ...
                    <div className='mt-8'>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <section className='group border-dotted border-2 ring-black p-4 my-4 flow-root'>
                                ...
                                <input className='text-black border p-1 rounded' ref={register} name="rueValue" placeholder='Rue Value' />
                                    <section className="sectionGroup border-dotted border-2 ring-black p-4 my-4 flow-root">
                                        <div className='pb-2'>
                                            <select

...
console.log('produs venit de la store', product.totalCost)
    
    function counterAction() {
        if((thisCount +1)  === 1) {
            totalCostGlobal = constNewProduct.price;
            console.log('totalCostGlobal initial',totalCostGlobal)
           } else if((thisCount + 1) === 2 ) {
            totalCostGlobal = constNewProduct.price * 2;
            console.log('totalCostGlobal * 2---',totalCostGlobal)
           } else if((thisCount + 1) > 2) {
            totalCostGlobal = constNewProduct.price * (thisCount + 1);
            console.log('totalCostGlobal > 2----',totalCostGlobal, thisCount + 1)
    ...
    return(
        <div className='w-80 h-96 bg-gray-50 shadow-md py-5 px-5 '>
            ...
            <p className='text-xl my-2'>&#36;{totalCostGlobal}</p>

...
const Product = ({product}) => {
    ...
    const [cuontItems, setCountItems] = useState(nrItems)

    const valueItems = nrItems.toString();
    console.log(typeof valueItems)
    ...
    return(
        <div className='w-80 h-96 bg-gray-50 shadow-md py-5 px-5 '>
            ...
            <div className='btns-counter h-12 box-border flex flex-wrap content-start'>
                ...
                <p className='inline-block w-12 h-12 text-center bg-gray-100 leading-10 '><span>{valueItems}</span></p>
                <button onClick={() => dispatch(increment())} className='inline-block rounded rounded-l-none w-12 h-12 bg-gray-200 pl-3 pt-1.5 hover:bg-gray-300' >

...
const LeftSideCategory = () => {
    ...
    let categoryComponents = CategoriesSelect.map(categObject => <li className='hover:bg-gray-400 pl-5 h-12 text-2xl cursor-pointer leading-3' key={categObject.id}>{categObject.name}</li>)
    return(

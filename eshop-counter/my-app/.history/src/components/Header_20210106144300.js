...
import {flagSelectorClick, updateCartIsClicked} from '../slices/flagIsClickedSlice';

const Header = () => {

  //const  value = useSelector(flagSelectorClick);

  const { cartFlagValue } = useSelector(state => state.isClikedFlag.cartFlagValue);
